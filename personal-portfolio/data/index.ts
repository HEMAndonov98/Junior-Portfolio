export const getImagePath = (path: string): string => {
	...
	const basePath =
		process.env.NODE_ENV === "production" ? "/Junior-Portfolio" : "";
...
export const projects = [
	{
		...
		iconLists: [
			...
			getImagePath("/SQL Database Icon.svg"),
			getImagePath("/JavaScript Icon.svg"),
		],
		link: "https://github.com/HEMAndonov98/TimeForge-Project-Manager",
	},
	{
		id: 2,
