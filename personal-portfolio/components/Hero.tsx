  ...
  return (
    <div className="pb-20 pt-36">
        <div>
            ...
            <Spotlight className='-top-10 -left-full h-[8-vh]
            w-[50vw]' fill='purple' />
            <Spotlight className='top-28 left-80
           h-[80vh] w-[50vw]' fill='blue' />            
        </div>
          <div className="h-screen w-full dark:bg-black-100 bg-white
            dark:bg-grid-white/[0.02] bg-grid-black/[0.2] absolute top-0 left-0 flex items-center
             justify-center">
        ...
        <div className='flex justify-center relative my-20 z-10'>
          ...
          items-center justify-center">
            <h2 className='uppercase tracking-widest text-xs text-center
             text-blue-100 max-xl:ax-w-80'>Creating beautiful ui&apos;s using Next.js</h2>
            ...
            md:text-lg lg:text-2xl'>
              Hi, I&apos;m Hristo, a .Net Developer based in Bulgaria.
            </p>
